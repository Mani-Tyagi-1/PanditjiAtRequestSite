...
- **seo-technical**: For fixing the technical foundation (JS rendering, robots.txt, etc.)
- **seo-geo**: For AI crawler access, llms.txt, passage citability
- **seo-aeo-keyword-research**: For keyword + AEO question research
- **seo-aeo-content-cluster**: For building topical authority clusters

See `references/service-marketplace-seo-aeo-geo.md` for a complete combined SEO/AEO/GEO strategy framework for service marketplaces, including skill orchestration order, TLS framework, and FAQPage schema templates.
