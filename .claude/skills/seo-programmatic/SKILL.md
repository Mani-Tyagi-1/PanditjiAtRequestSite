...
#### City/Service Template Specifics

For location-based service pages (pandits, doctors, tutors, contractors), use the 3-tier architecture and template design patterns in `references/city-service-programmatic-template.md`.
