            ...
            {isMobileMenuOpen && (
              <>
                ...
                <motion.div
                  ...
                  className="fixed top-0 right-0 h-full w-[280px] bg-white shadow-2xl z-10000 lg:hidden"
                >
            ...
            {isMobileMenuOpen && (
              <>
                ...
                <motion.div
                  ...
                  className="fixed inset-y-0 right-0 w-[86vw] max-w-[320px] bg-white shadow-2xl z-[9999] lg:hidden h-[100dvh]"
                >
                  <div className="flex flex-col h-full overflow-y-auto">
                    ...
                    <div className="flex items-start justify-between p-6 border-b">
                      <div className="text-center w-full pr-8">
                        ...
                        <h2 className="mt-1 text-xl font-semibold tracking-wider text-gray-900">
                          Pandit Ji At Request
                        </h2>
