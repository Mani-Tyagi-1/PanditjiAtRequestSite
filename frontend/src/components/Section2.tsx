              ...
              <div className=" relative w-[300px] md:w-[400px]">
                ...
                <div className="relative flex justify-center">
                  <a
                    ...
                    className="absolute bottom-40 right-[-20px] bg-orange-500 hover:bg-orange-600 text-white font-bold text-md px-6 py-2 rounded-full shadow-lg transform hover:scale-105 transition-all duration-300"
                  >
                    JOIN
                  </a>
                </div>
