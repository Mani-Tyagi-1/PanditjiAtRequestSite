    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <header className="bg-white border-b border-slate-200">
        <div className="max-w-4xl mx-auto px-6 py-8">
          ...
          <p className="mt-2 text-slate-600">Last Updated: November 7, 2025</p>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-8 space-y-8">
          ...
          <section>
            ...
            <h3 className="text-xl font-medium text-slate-800 mb-3 mt-6">
            ...
            <div className="bg-slate-50 border-l-4 border-blue-500 p-4 rounded">
              <p className="text-slate-700 leading-relaxed">
                ...
                address, phone number, mailing address, job title, company name,
            ...
            <p className="text-slate-700 leading-relaxed">
              ...
              name, country, location, and technical information.
            </p>
          </section>
            ...
            <div className="space-y-3 ml-4">
              <div className="flex items-start">
                ...
                <p className="text-slate-700">
                  Facilitate account creation and authentication processes
                </p>
              </div>
              <div className="flex items-start">
                <span className="inline-block w-2 h-2 bg-blue-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
              ...
              <div className="flex items-start">
                <span className="inline-block w-2 h-2 bg-blue-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                <p className="text-slate-700">
                  Process and manage your orders, payments, and transactions
                </p>
              </div>
              <div className="flex items-start">
                <span className="inline-block w-2 h-2 bg-blue-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
              ...
              <div className="flex items-start">
                <span className="inline-block w-2 h-2 bg-blue-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                <p className="text-slate-700">
                  Improve our website and services through analytics and
                  feedback
                </p>
              </div>
            </div>
          ...
          <section>
            ...
            <div className="bg-slate-50 rounded-lg p-6 space-y-4">
              <div>
                ...
                <p className="text-slate-700">
                  We may share your data with third-party vendors who perform
              ...
              <div>
                ...
                <p className="text-slate-700">
                  We may share or transfer your information in connection with a
          ...
          <section>
            ...
            <p className="text-slate-700 leading-relaxed">
              ...
              please note that no electronic transmission over the Internet or
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="border border-slate-200 rounded-lg p-4">
                <h4 className="font-semibold text-slate-800 mb-2">Access</h4>
              ...
              <div className="border border-slate-200 rounded-lg p-4">
                <h4 className="font-semibold text-slate-800 mb-2">Objection</h4>
                <p className="text-slate-600 text-sm">
          ...
          <section>
            ...
            <p className="text-slate-700 leading-relaxed">
              ...
              any third-party sites or services. We strongly advise you to
