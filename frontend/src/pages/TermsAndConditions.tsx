    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50 mt-20">
        ...
        <main className="max-w-4xl mx-auto px-4 md:px-6 py-10 space-y-5">
          ...
          <SectionCard number="2" title="Scope of Services">
            <p>Pandit Ji At Request is a technology platform that enables users to book:</p>
            <ul className="space-y-1.5 mt-2">
              <Bullet>Home puja services</Bullet>
              <Bullet>Online puja / consultations</Bullet>
              <Bullet>Temple offerings / prasad</Bullet>
              <Bullet>Astrology / spiritual services</Bullet>
            </ul>
            <p className="mt-3">The Company does <span className="font-semibold">NOT</span> perform rituals directly. Services are performed by independent pandits / partners.</p>
          </SectionCard>

          <SectionCard number="3" title="Acceptance of Terms">
            <p>By using the platform, you agree that:</p>
            <ul className="space-y-1.5 mt-2">
              <Bullet>You have read and accepted these Terms</Bullet>
              <Bullet>You are legally capable of entering into a contract</Bullet>
              <Bullet>You agree to the Privacy Policy</Bullet>
            </ul>
          </SectionCard>
          ...
          <SectionCard number="4" title="Eligibility">
            <p>You must:</p>
            <ul className="space-y-1.5 mt-2">
              <Bullet>Be 18+ OR use under guardian supervision</Bullet>
              <Bullet>Provide accurate details</Bullet>
              <Bullet>Use valid contact information</Bullet>
            </ul>
          </SectionCard>

          <SectionCard number="5" title="Account &amp; OTP Responsibility">
            <p>You are responsible for:</p>
            <ul className="space-y-1.5 mt-2">
              <Bullet>OTP security</Bullet>
              <Bullet>Account usage</Bullet>
              <Bullet>Unauthorized access</Bullet>
            </ul>
            <p className="mt-3">Any activity via your account is treated as authorized.</p>
          </SectionCard>

          <SectionCard number="6" title="Booking Process">
            <p>A booking is confirmed only after Platform confirmation (SMS / WhatsApp / Email / App).</p>
            <p className="mt-2">Depends on:</p>
            <ul className="space-y-1.5 mt-2">
              <Bullet>Pandit availability</Bullet>
              <Bullet>Location serviceability</Bullet>
              <Bullet>Payment success</Bullet>
            </ul>
          </SectionCard>

          <SectionCard number="7" title="Pricing &amp; Variations">
            <p>Prices may vary based on:</p>
            <ul className="space-y-1.5 mt-2">
              <Bullet>Location</Bullet>
              <Bullet>Festival demand</Bullet>
              <Bullet>Samagri</Bullet>
              <Bullet>Duration</Bullet>
            </ul>
            <p className="mt-3 font-semibold text-orange-700">Important:</p>
            <p>Final cost may change if:</p>
            <ul className="space-y-1.5 mt-2">
              <Bullet>Additional rituals requested</Bullet>
              <Bullet>Extra samagri required</Bullet>
              <Bullet>Duration increases</Bullet>
            </ul>
          </SectionCard>

          <SectionCard number="8" title="Payments">
            <ul className="space-y-1.5">
              <Bullet>Processed via third-party gateways</Bullet>
              <Bullet>Platform does not store card data</Bullet>
            </ul>
            <p className="mt-3 font-semibold text-orange-700">Fraud / chargeback:</p>
            <ul className="space-y-1.5 mt-2">
              <Bullet>Account may be suspended</Bullet>
              <Bullet>Legal recovery may be initiated</Bullet>
            </ul>
          </SectionCard>

          <SectionCard number="9" title="Cancellation, Refund &amp; Rescheduling">
            <SubSection label="9.1 User Cancellation">
              <ul className="space-y-1.5 mt-2">
                <Bullet>More than 24 hrs: partial refund</Bullet>
                <Bullet>12 to 24 hrs: limited refund</Bullet>
                <Bullet>Less than 12 hrs: no refund</Bullet>
              </ul>
            </SubSection>
            <SubSection label="9.2 Non-Responsive User Clause">
              <p>If user does not answer calls/messages or confirm details, Platform may:</p>
              <ul className="space-y-1 mt-1">
                <Bullet>Cancel booking</Bullet>
                <Bullet>No refund applicable</Bullet>
              </ul>
            </SubSection>
            <SubSection label="9.3 Non-Refundable Cases">
              <p>No refund if:</p>
              <ul className="space-y-1 mt-1">
                <Bullet>Wrong address</Bullet>
                <Bullet>User unavailable</Bullet>
                <Bullet>Late changes</Bullet>
                <Bullet>Service already started</Bullet>
                <Bullet>Festival / custom bookings</Bullet>
              </ul>
            </SubSection>
            <SubSection label="9.4 Non-Cancellable Services">
              <p>Certain services may be marked non-cancellable / non-refundable.</p>
            </SubSection>
            <SubSection label="9.5 Refund Timeline">
              <p>7 to 10 working days (bank dependent).</p>
            </SubSection>
          </SectionCard>

          <SectionCard number="10" title="Service Delivery Conditions">
            <p>Time is approximate and may vary due to:</p>
            <ul className="space-y-1.5 mt-2">
              <Bullet>Traffic</Bullet>
              <Bullet>Festivals</Bullet>
              <Bullet>Weather</Bullet>
              <Bullet>Prior bookings</Bullet>
            </ul>
            <SubSection label="Pandit Delay / No-Show Clause">
              <p>Platform is NOT liable for:</p>
              <ul className="space-y-1 mt-1">
                <Bullet>Pandit illness</Bullet>
                <Bullet>Emergencies</Bullet>
                <Bullet>Travel delays</Bullet>
                <Bullet>Religious constraints</Bullet>
              </ul>
              <p className="mt-2">Platform may reschedule, replace pandit, or offer partial compensation if applicable.</p>
            </SubSection>
          </SectionCard>

          <SectionCard number="11" title="Service Completion Definition">
            <p>A service is considered completed when:</p>
            <ul className="space-y-1.5 mt-2">
              <Bullet>Pandit arrives &amp; performs ritual</Bullet>
              <Bullet>OR online session completed</Bullet>
              <Bullet>OR minimum duration served</Bullet>
            </ul>
          </SectionCard>

          <SectionCard number="12" title="User Responsibilities">
            <p>You must:</p>
            <ul className="space-y-1.5 mt-2">
              <Bullet>Provide correct details</Bullet>
              <Bullet>Ensure access to location</Bullet>
              <Bullet>Maintain respectful behavior</Bullet>
            </ul>
          </SectionCard>

          <SectionCard number="13" title="Off-Platform Dealing Ban">
            <p>Users and pandits MUST NOT:</p>
            <ul className="space-y-1.5 mt-2">
              <Bullet>Exchange personal contact for direct booking</Bullet>
              <Bullet>Bypass platform payments</Bullet>
            </ul>
            <p className="mt-3">Violation may result in:</p>
            <ul className="space-y-1.5 mt-2">
              <Bullet>Permanent ban</Bullet>
              <Bullet>Legal action</Bullet>
              <Bullet>Recovery of losses</Bullet>
            </ul>
          </SectionCard>

          <SectionCard number="14" title="Service Provider Relationship">
            <p>Pandits are:</p>
            <ul className="space-y-1.5 mt-2">
              <Bullet>Independent contractors</Bullet>
              <Bullet>Not employees</Bullet>
            </ul>
            <p className="mt-3">Ritual variations do NOT count as service failure.</p>
          </SectionCard>

          <SectionCard number="15" title="No Guarantee of Results">
            <p>We do NOT guarantee:</p>
            <ul className="space-y-1.5 mt-2">
              <Bullet>Spiritual outcomes</Bullet>
              <Bullet>Financial / health / relationship results</Bullet>
            </ul>
          </SectionCard>

          <SectionCard number="16" title="Communication Consent">
            <p>You agree to receive:</p>
            <ul className="space-y-1.5 mt-2">
              <Bullet>Calls</Bullet>
              <Bullet>SMS</Bullet>
              <Bullet>WhatsApp</Bullet>
          ...
          <SectionCard number="17" title="Call &amp; Recording Clause">
            <p>Calls / sessions may be monitored and recorded for:</p>
            <ul className="space-y-1.5 mt-2">
              <Bullet>Quality</Bullet>
              <Bullet>Safety</Bullet>
              <Bullet>Dispute resolution</Bullet>
            </ul>
          </SectionCard>

          <SectionCard number="18" title="Location Tracking">
            <p>Platform may:</p>
            <ul className="space-y-1.5 mt-2">
              <Bullet>Track pandit location</Bullet>
              <Bullet>Share real-time tracking with users</Bullet>
            </ul>
          </SectionCard>

          <SectionCard number="19" title="Reviews &amp; Content">
            <p>You agree:</p>
            <ul className="space-y-1.5 mt-2">
              <Bullet>Content is lawful</Bullet>
              <Bullet>Platform may use it for marketing</Bullet>
            </ul>
          </SectionCard>

          <SectionCard number="20" title="Prohibited Activities">
            <p>You must NOT:</p>
            <ul className="space-y-1.5 mt-2">
              <Bullet>Use bots / scraping</Bullet>
              <Bullet>Abuse system</Bullet>
              <Bullet>Harass pandits</Bullet>
              <Bullet>Provide false data</Bullet>
            </ul>
          </SectionCard>

          <SectionCard number="21" title="Intellectual Property">
            <ul className="space-y-1.5">
              <Bullet>All content belongs to Company</Bullet>
              <Bullet>No unauthorized use allowed</Bullet>
            </ul>
          </SectionCard>

          <SectionCard number="22" title="Third-Party Services">
            <p>Platform integrates:</p>
            <ul className="space-y-1.5 mt-2">
              <Bullet>Payment gateways</Bullet>
              <Bullet>Maps</Bullet>
              <Bullet>Messaging</Bullet>
            </ul>
            <p className="mt-3">We are NOT liable for their failures.</p>
          </SectionCard>

          <SectionCard number="23" title="Data &amp; Legal Disclosure">
            <p>Platform may share data:</p>
            <ul className="space-y-1.5 mt-2">
              <Bullet>With authorities</Bullet>
              <Bullet>For legal compliance</Bullet>
              <Bullet>To protect platform</Bullet>
            </ul>
          </SectionCard>

          <SectionCard number="24" title="Content Accuracy Disclaimer">
            <ul className="space-y-1.5">
              <Bullet>Ritual / astrology info may not be 100% accurate</Bullet>
              <Bullet>Content is for general understanding</Bullet>
            </ul>
          </SectionCard>

          <SectionCard number="25" title="Product / Samagri Disclaimer">
            <ul className="space-y-1.5">
              <Bullet>Items / prasad may slightly vary</Bullet>
              <Bullet>Images are indicative</Bullet>
            </ul>
          </SectionCard>

          <SectionCard number="26" title="Mental / Medical Disclaimer">
            <p>Services are NOT a substitute for:</p>
            <ul className="space-y-1.5 mt-2">
              <Bullet>Medical advice</Bullet>
              <Bullet>Legal advice</Bullet>
              <Bullet>Financial advice</Bullet>
            </ul>
          </SectionCard>

          <SectionCard number="27" title="Suspension &amp; Termination">
            <p>We may suspend account or cancel bookings if:</p>
            <ul className="space-y-1.5 mt-2">
              <Bullet>Fraud</Bullet>
              <Bullet>Abuse</Bullet>
              <Bullet>Risk to platform</Bullet>
            </ul>
          </SectionCard>

          <SectionCard number="28" title="Disclaimer of Warranties">
            <p>Platform is provided on an &quot;as is&quot; and &quot;as available&quot; basis.</p>
          </SectionCard>

          <SectionCard number="29" title="Limitation of Liability">
            <p>Maximum liability = amount paid for the specific booking.</p>
          </SectionCard>

          <SectionCard number="30" title="Indemnity">
            <p>User will cover losses caused by:</p>
            <ul className="space-y-1.5 mt-2">
              <Bullet>Misuse</Bullet>
              <Bullet>Legal violations</Bullet>
            </ul>
          </SectionCard>

          <SectionCard number="31" title="Force Majeure">
            <p>Includes:</p>
            <ul className="space-y-1.5 mt-2">
              <Bullet>Natural disasters</Bullet>
              <Bullet>Govt restrictions</Bullet>
              <Bullet>Temple closure</Bullet>
              <Bullet>Religious events</Bullet>
            </ul>
          </SectionCard>

          <SectionCard number="32" title="Governing Law">
            <ul className="space-y-1.5">
              <Bullet>India law applies</Bullet>
              <Bullet>Jurisdiction: Punjab courts</Bullet>
            </ul>
          </SectionCard>

          <SectionCard number="33" title="Grievance Officer">
            <div className="mt-2">
              <InfoBox>
                <p>Email: panditjiatrequest@vedicvaibhav.com</p>
          ...
          <SectionCard number="34" title="Changes to Terms">
            <p>We may update terms anytime. Your continued use of the Platform constitutes acceptance.</p>
          </SectionCard>

          <SectionCard number="35" title="Entire Agreement">
            <p>This Terms document + Privacy Policy = full agreement.</p>
          </SectionCard>

          <SectionCard number="36" title="Contact Information">
            <p>For questions, support, legal notices, grievances, or concerns regarding these Terms:</p>
            <div className="mt-3">
              <InfoBox>
                <p className="font-semibold text-stone-800">Vedic Vaibhav Dot Com Pvt Ltd</p>
