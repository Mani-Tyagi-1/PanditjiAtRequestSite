...
export default function PanditBookingModal({ isOpen, onClose, pandit }: Props) {
    ...
    const goNext = () => {
        ...
        if (step === "service") {
            ...
            if (form.date < minDate) { setError("Please pick a future date."); return; }
                    ...
                    >
                        ...
                        <div className="relative shrink-0 bg-gradient-to-br from-indigo-600 to-violet-600 px-5 pt-5 pb-4">
                            ...
                            <div className="flex items-center gap-3">
                                <img loading="lazy" decoding="async" src={pandit.image} alt={pandit.name} className="w-14 h-14 rounded-2xl object-cover border-2 border-white/40" />
