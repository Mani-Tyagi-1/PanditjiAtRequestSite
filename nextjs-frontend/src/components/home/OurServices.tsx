...
const SERVICES: { image: string; title: string; path: string; newTab?: boolean }[] = [
    { image: "/images/pooja_for_home.webp", title: "Pooja for Home", path: "/book-puja" },
    { image: "/images/live_pooja.webp", title: "Live Pooja at Mandir", path: "/book-puja?tab=mandir" },
    { image: "/images/chadhava.webp", title: "Chadhava at Mandir", path: "/chadhava" },
    ...
    { image: "/images/vivah_sanskar_service.webp", title: "Vivah Sanskar", path: "/vedic-vivah", newTab: true },
    { image: "/images/pandit_kashi.webp", title: "Pandit Ji from Kashi", path: "/kashi" },
    { image: "/images/shop_service.webp", title: "Shop", path: "/shop" },
];
