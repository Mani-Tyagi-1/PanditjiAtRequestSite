...
export function useAuth() {
    ...
    // The session is restored from localStorage after mount, and AuthProvider can finish
    // that before a Suspense-wrapped page has hydrated. Without this gate such a page's
    // first client render sees a logged-in user the server HTML never had (hydration
    // mismatch). false while hydrating, true afterwards.
