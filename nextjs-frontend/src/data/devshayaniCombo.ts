...
export const COMBO_PRICE = num(
  typeof process !== "undefined"
    ? process.env.NEXT_PUBLIC_DEVSHAYANI_COMBO_PRICE || process.env.VITE_DEVSHAYANI_COMBO_PRICE
    : 1100,
  1100
);
/** Struck-through "original" price, for the savings badge. */
export const COMBO_ORIGINAL = num(
  typeof process !== "undefined"
    ? process.env.NEXT_PUBLIC_DEVSHAYANI_COMBO_ORIGINAL || process.env.VITE_DEVSHAYANI_COMBO_ORIGINAL
    : 2100,
  2100
);
/** Optional prasad-box add-on (fixed at 298 across the whole chadhava flow). */
export const COMBO_PRASAD_PRICE = num(
  typeof process !== "undefined"
    ? process.env.NEXT_PUBLIC_DEVSHAYANI_PRASAD_PRICE || process.env.VITE_DEVSHAYANI_PRASAD_PRICE
    : 298,
  298
);
...
export const COMBO_DATE: string =
  (typeof process !== "undefined" &&
    (process.env.NEXT_PUBLIC_DEVSHAYANI_DATE || process.env.VITE_DEVSHAYANI_DATE)) ||
  "2026-07-25T06:00:00+05:30";
