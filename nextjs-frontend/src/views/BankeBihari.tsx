...
const PujaEnquiryModal = dynamic(() => import("../components/booking/PujaEnquiryModal"), { ssr: false });
...
function HeroCountdown({ target }: { target: number }) {
    // Starts at 0 and is filled in by the effect below: seeding from Date.now() during
    // render never matches the prerendered HTML and forces a full client re-render.
