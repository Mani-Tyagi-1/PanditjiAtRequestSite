...
const SacredChadhavaSewa = dynamic(() => import("../components/home/SacredChadhavaSewa"));
const VerifiedPanditJi = dynamic(() => import("../components/home/VerifiedPanditJi"));
const PoojaByProblem = dynamic(() => import("../components/home/PoojaByProblem"));
const Testimonials = dynamic(() => import("../components/booking/Testimonials"));
const FAQSection = dynamic(() => import("../components/home/FAQSection"));
const TrustSanatanSection = dynamic(() => import("../components/home/TrustSanatanSection"));
...
export default function HomePage() {
    ...
    useEffect(() => {
        const fetchPoojas = async () => {
            try {
                const { data } = await cachedGet(`${API_URL}/fetch-all-poojas`);
