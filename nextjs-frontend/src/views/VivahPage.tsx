...
const RitualDrawer = dynamic(() => import("../components/vivah/RitualDrawer"), { ssr: false });
const VivahConsultModal = dynamic(() => import("../components/vivah/VivahConsultModal"), { ssr: false });
import {
  Btn,
  Card,
  Head,
