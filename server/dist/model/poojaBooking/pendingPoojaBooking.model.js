...
const PendingPoojaBookingSchema = new mongoose_1.Schema({
...
// Virtual string id for cleaner client payloads
PendingPoojaBookingSchema.virtual('id').get(function () {
...
exports.default = connectDB_1.panditJiAtRequestMongooose.model('PendingPoojaBooking', PendingPoojaBookingSchema);
