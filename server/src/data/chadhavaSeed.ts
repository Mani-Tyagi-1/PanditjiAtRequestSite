import { IChadhava, IChadhavaOffering, IAddOnProduct } from "../model/userApp/chadhavaModel";

type SeedChadhava = Omit<IChadhava, "isActive" | "createdAt">;

// Global prasad box upsell — same for every chadhava.
export const PRASAD_BOX_UPSELL: IAddOnProduct = {
...
const offerings = (base: number): IChadhavaOffering[] => [
...
export const CHADHAVA_SEED: SeedChadhava[] = [
  {
    slug: "khatu-shyam-chola",
